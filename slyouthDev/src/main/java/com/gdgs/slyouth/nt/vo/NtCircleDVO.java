...
/**
 * @title   : [커뮤니티] 동아리 DVO 클래스     
 * @author  : 송근영
 * @create  : 2021.07.25
 * @update  : 2021.08.16
 */
public class NtCircleDVO extends CmBaseVO{
	
	/** 테이블 변수(행사) */
	private int eventNo;			// 행사번호(동아리번호)
	private String eventDivCd;		// 행사구분코드
	private String eventNm;			// 행사명(동아리명)
	private String eventIntro;		// 행사소개(동아리소개)
	private int repImgNo;			// 행사이미지번호
	private int mngNo;				// 담당자번호(교적번호)
	private int peopleNum;			// 인원수
	private String strYmd;			// 시작일자(동아리시작일자)
	private String strTm; 			// 시작시각(동아리시작시각)
	private String endYmd;			// 종료일자(동아리종료일자)
	private String endTm;			// 종료시각(동아리종료시각)
	private String place;			// 장소
	private String remark;			// 비고
	private String appStrYmd;		// 신청시작일자(동아리신청시작일자)
	private String appStrTm;		// 신청시작시각(동아리신청시작시각)
	private String appEndYmd; 		// 신청종료일자(동아리신청종료일자)
	private String appEndTm;		// 신청종료시각(동아리신청종료시각)
